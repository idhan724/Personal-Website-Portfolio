...
const PillNav: React.FC<PillNavProps> = ({
  ...
  return (
    <div className="fixed top-[1em] left-0 right-0 z-[1000] w-full">
      <div className="grid grid-cols-3 px-6 items-center">
        <div className="flex justify-start">
          ...
          >
            <span className="hamburger-line w-4 h-0.5 rounded origin-center transition-all duration-[10ms] ease-[cubic-bezier(0.25,0.1,0.25,1)] bg-foreground" />
            <span className="hamburger-line w-4 h-0.5 rounded origin-center transition-all duration-[10ms] ease-[cubic-bezier(0.25,0.1,0.25,1)] bg-foreground" />
          </button>
        </div>
        <div className="flex justify-center">
          <nav
            className={`w-full md:w-max flex items-center md:justify-start box-border px-4 md:px-0 ${className}`}
            aria-label="Primary"
            style={cssVars}
          >
            <div
